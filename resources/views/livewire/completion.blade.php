<section class="p-4 sm:p-8 bg-[#fdf2e3] rounded-xl">
    ...
    <form class="font-mono uppercase mt-8 grid grid-cols-3 gap-y-4">
        <div class="col-span-2 pb-4 border-b-2 border-dotted border-zinc-800">1. S'enregister et approuver <a href="{{ route('policy') }}" class="underline whitespace-nowrap">les conditions d'utilisation</a> du site</div>
        ...
        <div class="col-span-2 pb-4 border-b-2 border-dotted border-zinc-800">2. Lire ou écouter <a href="{{ route('step1') }}" class="underline whitespace-nowrap">la partie théorique</a></div>
        <div class="flex items-center justify-end gap-4 pb-4 border-b-2 border-dotted border-zinc-800">
        ...
        <div class="col-span-2 pb-4 border-b-2 border-dotted border-zinc-800">5. Remplir le <a href="{{ route('step2') }}" class="underline whitespace-nowrap">questionnaire quota des privilèges</a></div>
        <div class="flex items-center justify-end gap-4 pb-4 border-b-2 border-dotted border-zinc-800">
        ...
        <div class="col-span-2 pb-4 border-b-2 border-dotted border-zinc-800">6. Lire la brochure et remplir le <a href="{{ route('step3') }}" class="underline whitespace-nowrap">bulletin de vote sur la loterie sociale</a></div>
        <div class="flex items-center justify-end gap-4 pb-4 border-b-2 border-dotted border-zinc-800">
        ...
        <div class="col-span-2 pb-4 border-b-2 border-zinc-800">7. Passer au studio pour la <a href="{{ route('step4') }}" class="underline whitespace-nowrap">session photo</a> et l'enregistrement de notre entretien</div>
