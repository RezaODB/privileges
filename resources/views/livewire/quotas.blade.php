<form wire:submit class="grid grid-cols-[1fr_auto] items-end px-2 sm:px-8 mt-16">
    <h2 class="text-3xl uppercase border-b-2 border-zinc-800 pb-4">{{ __('content.form') }}</h2>
    ...
    <div class="font-mono py-3 border-b-2 border-zinc-800 border-dotted flex items-center gap-4">
    ...
    <div class="flex flex-col lg:flex-row gap-x-6 gap-y-4 mt-12 col-span-2">
        ...
        <textarea wire:model.live.debounce.1000ms="answers.comment" id="comment" rows="5" class="w-full h-full focus:ring-0"></textarea>
    </div>
</form>
