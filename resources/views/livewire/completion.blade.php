<section class="p-4 sm:p-8 bg-[#fdf2e3] rounded-xl">
    ...
    <form class="font-mono uppercase mt-8 grid grid-cols-3 gap-y-4">
        ...
        <div class="flex items-center justify-end gap-4 pb-4 border-b-2 border-dotted border-zinc-800">
            <span>10min</span>
            <input type="checkbox"  wire:model.live="completion.1" id="check1" class="border-none text-zinc-800 focus:ring-0 checked:bg-none">
        </div>
        ...
        <div class="flex items-center justify-end gap-4 pb-4 border-b-2 border-dotted border-zinc-800">
            <span>20min</span>
            <input type="checkbox"  wire:model.live="completion.2" id="check2" class="border-none text-zinc-800 focus:ring-0 checked:bg-none">
        </div>
        ...
        <div class="flex items-center justify-end gap-4 pb-4 border-b-2 border-dotted border-zinc-800">
            <span>30min</span>
            <input type="checkbox"  wire:model.live="completion.3" id="check3" class="border-none text-zinc-800 focus:ring-0 checked:bg-none">
        </div>
        ...
        <div class="flex items-center justify-end gap-4 pb-4 border-b-2 border-dotted border-zinc-800">
            <input type="checkbox"  wire:model.live="completion.4" id="check4" class="border-none text-zinc-800 focus:ring-0 checked:bg-none">
        </div>
        ...
        <div class="flex items-center justify-end gap-4 pb-4 border-b-2 border-dotted border-zinc-800">
            <span>30min</span>
            <input type="checkbox"  wire:model.live="completion.5" id="check5" class="border-none text-zinc-800 focus:ring-0 checked:bg-none">
        </div>
        ...
        <div class="flex items-center justify-end gap-4 pb-4 border-b-2 border-dotted border-zinc-800">
            <span>30min</span>
            <input type="checkbox"  wire:model.live="completion.6" id="check6" class="border-none text-zinc-800 focus:ring-0 checked:bg-none">
        </div>
        ...
        <div class="flex items-center justify-end gap-4 pb-4 border-b-2 border-zinc-800">
            <span>120min</span>
            <input type="checkbox"  wire:model.live="completion.7" id="check7" class="border-none text-zinc-800 focus:ring-0 checked:bg-none">
        </div>
