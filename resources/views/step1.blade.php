...
<section class="bg-stone-100 px-4 md:px-8 py-16 shadow-xl">
    <div class="flex gap-8 items-start justify-between" x-data="{ title: 0 }">
        <div class="space-y-8">
            ...
            <div class="prose mt-8 prose-blockquote:text-2xl prose-blockquote:font-serif prose-blockquote:not-italic prose-blockquote:border-l-0 prose-blockquote:max-w-lg prose-blockquote:pl-0 prose-blockquote:ml-auto prose-blockquote:text-right md:prose-blockquote:-mr-12">{!! $item->body !!}</div>
            @endforeach
        </div>
