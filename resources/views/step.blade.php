    ...
    <div class="font-mono mb-4 px-2 sm:px-8" x-data="{ open: false }">
        ...
        <div class="grid duration-500" x-bind:class="open ? 'grid-rows-[1fr]' : 'grid-rows-[0fr]'">
            <div class="overflow-hidden">
                ...
                <div class="pb-12 prose max-w-none columns-md gap-12 [column-rule:2px_solid_black] prose-a:underline prose-p:text-justify prose-h2:font-sans prose-h2:text-xl prose-h2:uppercase prose-h2:font-normal prose-h2:border-b-2 prose-h2:border-zinc-800 prose-h2:pb-4 prose-h2:-mx-6 prose-h2:px-6 prose-h3:font-sans prose-h3:uppercase prose-h3:font-medium prose-blockquote:border-y-2 prose-blockquote:border-x-0 prose-blockquote:border-zinc-800 prose-blockquote:-mx-6 prose-blockquote:text-xl prose-blockquote:uppercase prose-blockquote:py-2 prose-blockquote:px-6 prose-blockquote:not-italic prose-blockquote:text-center prose-blockquote:text-[#374151]">{!! $item->body !!}</div>
            </div>
        </div>
    </div>
    @endforeach
