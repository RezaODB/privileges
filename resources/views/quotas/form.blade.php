<div class="grid grid-cols-1 gap-4">
    ...
    <input type="text" name="category" placeholder="Catégorie" class="border-gray-200 shadow rounded-md">
    ...
    <textarea name="question_en" rows="3" placeholder="Question EN" class="border-gray-200 shadow rounded-md">{{ old('question_en') ?? $quota->question_en }}</textarea>
